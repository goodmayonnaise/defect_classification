...
def main():
    ...
    if "efficientnet" in args.arch :
        ...
        for idx in block_list:
            ...
            feat_names.append(f"block{idx}")
        model.module._conv_head.register_forward_hook(save_feature("conv_head"))
        feat_names.append("conv_head")
    elif "resnet" in args.arch:
        feat_names = ["layer1", "layer2", "layer3", "layer4"]
        model.module.layer1.register_forward_hook(save_feature(f"layer1"))
        model.module.layer2.register_forward_hook(save_feature("layer2"))
        model.module.layer3.register_forward_hook(save_feature("layer3"))
        model.module.layer4.register_forward_hook(save_feature("layer4"))
